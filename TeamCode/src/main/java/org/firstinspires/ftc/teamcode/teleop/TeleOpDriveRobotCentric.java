...
public class TeleOpDriveRobotCentric extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            // Robot Centric Mode use the left joystick to go forward & strafe,
            // and the right joystick to rotate from the perspective of the robot.
